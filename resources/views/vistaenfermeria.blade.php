...
<html lang="en">
  ...
  <body class="app sidebar-mini rtl">
   ...
   <header class="app-header"><a style=" color:#F5DA81; font-size: 40px "  class="app-header__logo" href="#">C. Fisiosur</a>
    ...
    <li><a class="app-menu__item " href="{{route('enfermeria.index')}}"><i class="app-menu__icon fa fa-bar-chart" aria-hidden="true"></i><span class="app-menu__label">Gestionar tratamientos</span></a></li>
    ...
    <main class="app-content">
      <div class="app-title">
        <div>
          ...
          <p>Muestra de datos relevantes de la clinica Fisiosur</p>
        </div>
...
<div class="col-md-6 col-lg-3">
      ...
      <div class="row">
        <div class="col-md-10">
          <div class="tile">
            <center><h5  > AGENDA MEDICA DE TRATAMIENTOS </h5></center>
