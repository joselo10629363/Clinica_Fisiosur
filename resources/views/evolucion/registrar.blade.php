      ...
      <div class="row">
        ...
        <div class="form-group">
                    ...
                    <select  name="diagnostico_id"  class="form-control">
                     ...
                     <option value="{{$diagnostico['id']}}">{{$diagnostico->paciente->persona->nombre }} {{$diagnostico->paciente->persona->apellido1 }} {{$diagnostico->paciente->persona->apellido2 }} </option>
                    </select> 
                  </div>
